...
<body>
    ...
    <div class="container editContainer">
        ...
        <h1 class="header text-center">Update Bus Details</h1>
        <center>
            <hr width="1000px"><br>
        </center>
            ...
            <div class="row">
                <div class="col colum1">
                    ...
                    <div class="mb-3 ">
                        ...
                        <input type="text" class="form-control" id="busname" value="<%=busName%>" name="busname">
                    </div>

                    <div class="mb-3 ">
                        <label for="facilities" class="form-label">Facilities:</label>
                        <input type="text" class="form-control" id="facilities" value="<%=facilities%>" name="facilities">
                    </div>
                    ...
                    <div class="col column2">
                        <div class="mb-3 ">
                            ...
                            <input type="text" class="form-control" id="noplate" value="<%=bNoPlate%>" name="noplate">
                        </div>

                        <div class="mb-3">
                            <label for="seatcount" class="form-label">Seat Count:</label>
                            <input type="text" class="form-control" id="seatcount" value="<%=seatCount%>" name="seatcount">
                        </div>
    
                        <div class="mb-3 ">
                            <label for="bookedSeatCount" class="form-label">Booked Seat Count:</label>
                            <input type="text" class="form-control" id="bookedSeatCount" value="<%=bookedSeatCount%>" name="bseatcount">
                        </div>
                    </div>
            </div>       
                    <div class="row">
